...
# ----------------------------
PRODUCTS = [
    'молоко 2.5%', 'кефир', 'тdasвdasоdsaрог 5%', 'сыр российский', 'яйца c0', 'йогурт натураль',
    'батон нарезанный', 'хлеб ржаной', 'лаваш', 'пирожки',
    'колбаса докторская', 'курица бройлер', 'свинина', 'сосиски молочные', 'фарш говяжий',
    'картофель', 'огурdasцы', 'помидоddasasdadaры', 'моркоdsaвdsaь', 'лук репчатый', 'бананы', 'яблоки гала',
